...
process MATCH_READS {
    ...
    cp -P $corrected_barcode_fastq match_pair_first_read/
    cp -P $read1_fastq match_pair_first_read/
    ...
    cp -P $corrected_barcode_fastq match_pair_second_read/
    cp -P $read2_fastq match_pair_second_read/

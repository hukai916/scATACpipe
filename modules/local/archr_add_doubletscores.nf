...
process ARCHR_ADD_DOUBLETSCORES {
    ...
    // path quality_control, emit: quality_control // if using this syntax, the -resume breaks
    // path "QualityControl", emit: quality_control // using this, the -resume breaks too.

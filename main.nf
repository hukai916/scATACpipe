...
def checkPathParamList = [ params.input_fragment, params.input_fastq, params.ref_bwa_index, params.ref_minimap2_index, params.ref_cellranger_index, params.ref_gtf, params.ref_fasta, params.barcode_whitelist, params.archr_genome_fasta, params.archr_blacklist, params.archr_scrnaseq ]
